...
export class PageHelper {
    ...
    get blankPage() {
        if (this._blankPage === undefined) {
            this._blankPage = new BlankPage(this._browserHelper, this._stepSequenceHelper, this._storageStateHelper);
        }
    ...
    get loginPage() {
        if (this._loginPage === undefined) {
            this._loginPage = new LoginPage(this._browserHelper, this._stepSequenceHelper, this._storageStateHelper);
        }
    ...
    get adminPanelPage() {
        if (this._adminPanelPage === undefined) {
            this._adminPanelPage = new AdminPanelPage(this._browserHelper, this._stepSequenceHelper, this._storageStateHelper);
        }
    ...
    get errorPage() {
        if (this._errorPage === undefined) {
            this._errorPage = new ErrorPage(this._browserHelper, this._stepSequenceHelper, this._storageStateHelper);
        }
    ...
    get homePage() {
        if (this._homePage === undefined) {
            this._homePage = new HomePage(this._browserHelper, this._stepSequenceHelper, this._storageStateHelper);
        }
    ...
    get ajaxDataPage() {
        if (this._ajaxDataPage === undefined) {
            this._ajaxDataPage = new AjaxDataPage(this._browserHelper, this._stepSequenceHelper, this._storageStateHelper);
        }
